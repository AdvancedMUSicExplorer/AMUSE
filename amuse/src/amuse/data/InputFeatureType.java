...
/**
 * Defines the Input Feature Type. Can be either
 * - raw unprocessed features from the Amuse feature database
 * - processed features from the Amuse processed feature database
 */
