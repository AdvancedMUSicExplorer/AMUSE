 ...
 */
package amuse.nodes.optimizer.methods.es.evaluation.interfaces;
...
/**
 * Each evaluation function must implement this interface
 * 
...
public interface EvaluationInterface {
	 ...
	 * @param isEvaluatedOnIndependentTestSet True if the evaluation is done on the independent test set; false (default) for evaluation on the optimization set
