...
import amuse.nodes.validator.measures.events.base.FalsePositives;
import amuse.nodes.validator.measures.events.base.TruePositives;

/**
 * Precision measure (share of true positives in relation to all positive predictions)
 *  
 * @author Igor Vatolkin
 * @version $Id: $
 */
public class Precision extends EventDetectionQualityDoubleMeasureCalculator {
	...
	public ValidationMeasure[] calculateMeasure(EventsDescription groundTruthEvents, EventsDescription predictedEvents) throws NodeException {
		...
		falsePositivesCalculator.setToleranceBoundary(this.getToleranceBoundary());
		ValidationMeasureDouble fp = (ValidationMeasureDouble)falsePositivesCalculator.calculateMeasure(groundTruthEvents, predictedEvents)[0];
		...
		precisionMeasure[0].setId(405);
		precisionMeasure[0].setName("Precision");
