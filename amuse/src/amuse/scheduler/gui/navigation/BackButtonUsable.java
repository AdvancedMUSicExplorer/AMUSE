...
/**
 * This interface is used in combination with <code>JPanelAmuseNavigator</code> to allow certain JPanels in the Wizard to have different "Back" button behavior.
 * @author Clemens Waeltken
 *
 */
public interface BackButtonUsable {
	/**
	...
	/**
	 * This method should return the text to be displayed on the "Back" button.
